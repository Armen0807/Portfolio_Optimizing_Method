...
class SharpeRatioConfig(AbstractStratConfig):
    class Config:
...
class SharpeRatioBacktestStrategy(AbstractBacktestStrategy):
    ...
    def run(self):
        ...
        print("Pondérations optimales pour maximiser le ratio de Sharpe :", weights)
...
if __name__ == "__main__":
    config = SharpeRatioConfig(risk_free_rate=0.0455)  # Example risk-free rate
